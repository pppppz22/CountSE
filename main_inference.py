...
def get_args_parser():
    ...
    parser.add_argument(
        "--query_mode", help="memory or topk"
    )
    parser.add_argument("--note", default="", help="add some notes to the experiment")
    parser.add_argument(
        "--device", default="cuda", help="device to use for training / testing"
    )
    parser.add_argument("--seed", default=215, type=int)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("CountGD training and evaluation script", parents=[get_args_parser()])
